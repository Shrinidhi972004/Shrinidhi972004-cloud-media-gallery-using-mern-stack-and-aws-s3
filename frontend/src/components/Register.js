...
import { UserPlus, Eye, EyeOff, LockKeyhole, Mail, UserRound } from 'lucide-react';

export default function Register({ onRegisterSuccess, setPage }) {
      ...
      <div className="hidden md:flex md:w-1/2 bg-[#0f172a] flex-col items-center justify-center p-12 text-white">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-lg">Upload, share, and enjoy your media anywhere.</p>
          </div>
          ...
          <div className="bg-[#1e293b] rounded-xl p-5 mb-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Simple interface to manage your photos and videos</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1e293b] rounded-xl p-5 mb-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Your media is safely stored on AWS S3</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full md:w-1/2 bg-white flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-500">Sign up to start your gallery journey</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div>
              <label className="block text-gray-700 text-sm font-medium mb-2" htmlFor="registerName">Full Name</label>
            ...
            <div>
              <label className="block text-gray-700 text-sm font-medium mb-2" htmlFor="registerEmail">Email Address</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div>
              <label className="block text-gray-700 text-sm font-medium mb-2" htmlFor="registerPassword">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
