...
export default function Login({ setToken, onSwitchToRegister }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 opacity-20"></div>
      
      {/* Logo/Title Area */}
      <div className="mb-8 text-center">
        <div className="inline-block p-3 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-full mb-4">
        ...
        <h1 className="text-4xl font-extrabold mb-2 text-white">Immersive Gallery</h1>
        <p className="text-gray-400">Store and showcase your media collection</p>
      </div>
      ...
      <div className="w-full max-w-md">
        <div className="bg-gray-800 bg-opacity-50 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-gray-700">
          ...
          <button
            onClick={handleLogin}
            disabled={isLoading}
            className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold py-3 px-4 rounded-lg transition duration-200 transform hover:translate-y-px active:translate-y-0 flex items-center justify-center"
          >
            {isLoading ? (
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>© 2025 Immersive Gallery. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
